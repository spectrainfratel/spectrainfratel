...
export default function ServiceCard({ service }) {
  return (
    <div className="shadow-sm hover:shadow-md transition-all duration-300 border-2 [border-image:linear-gradient(135deg,_rgba(2,197,253,1),_rgba(13,80,167,1))_1] w-full h-[550px] sm:h-[560px] flex flex-col bg-accent  overflow-hidden">
