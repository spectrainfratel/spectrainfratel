  ...
  return (
    <>
      ...
      <div className="relative w-full h-[900px] md:h-[650px] lg:h-[850px] text-white bg-[#001020] lg:px-7 md:px-7 sm:px-7 flex flex-col md:flex-row items-end-safe">
        ...
        <div className="left-container order-2 lg:order-1 md:order-1 sm:order-2 w-full md:w-full flex justify-center items-center">
          <div className="relative w-[85%] sm:w-[70%] md:w-[55%] lg:w-[50%] aspect-square">
            <Image
              src="/assets/twoImg.png"
              alt="About Us"
              fill
